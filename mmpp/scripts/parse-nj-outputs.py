...
def subtree_cluster(tree, bootcut, distcut):
...
for f in files:
    ...
    for bootcut in bootcuts:
        for distcut in distcuts:
            clustered, complement = subtree_cluster(tree, bootcut, distcut)
